...
@section('content')
    ...
    <div class="main-content">
        ...
        <section class="divider"  data-bg-img="images/pattern/pattern4.png"  data-margin-top="-34px">
            <div class="container">
        ...
        <!-- Section: Features -->
    @if($feature)
        @include('kidspro_dark.layouts.features.'.$feature.'')
    @endif
    ...
    <!-- Divider: Funfact -->
        ...
        <!-- Section: Courses -->
    @if($course)
        @include('kidspro_dark.layouts.courses.'.$course.'')
    @endif
    ...
    <!-- Section: Our Gallery -->
        ...
        <!-- Section: Our Team -->
    @if($teacher)
        @include('kidspro_dark.layouts.teachers.'.$teacher.'')
    @endif
    ...
    @if($testimonial)
        @include('kidspro_dark.layouts.testimonials.'.$testimonial.'')
    @endif
    <!-- Section: blog -->
    @if($news)
        @include('kidspro_dark.layouts.news.'.$news.'')
    @endif
