            ...
            <div class="section-title text-center">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h2 class="line-bottom-center text-white mt-0 mb-30">Happy Parent's Say</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="item">
                        <div class="testimonial-wrapper">
                            <div class="content bg-theme-color-orange p-30 pb-40">
                                ...
                                <div class="thumb mt-20"><img class="img-circle" alt="" src="http://placehold.it/100x100"></div>
                            </div>
                        </div>
                    </div>
                    <div class="item">
