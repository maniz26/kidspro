                            ...
                            <div class="entry-meta media mt-0 no-bg no-border">
                                ...
                                <div class="media-body pl-15">
                                    <div class="event-content pull-left flip">
                                        <h4 class="entry-title m-0 mt-5"><a class="text-theme-color-blue" href="#">This is a standard post with thumbnail</a></h4>
                                    </div>
                                </div>
                            </div>
                    ...
                    <article class="post clearfix mb-sm-30">
                        ...
                        <div class="entry-content p-20 pr-10  bg-white">
                            <div class="entry-meta media mt-0 no-bg no-border">
                                ...
                                <div class="media-body pl-15">
                                    <div class="event-content pull-left flip">
                                        <h4 class="entry-title m-0 mt-5"><a class="text-theme-color-red" href="#">This is a standard post with thumbnail</a></h4>
                                    </div>
                                </div>
                            </div>
                            <p class="mt-10">Lorem ipsum dolor sit amet, consectetur adipisi cing elit. Molestias eius illum libero dolor nobis deleniti, sint assumenda. Pariatur iste veritatis excepturi, ipsa optio nobis.
                    ...
                    <article class="post clearfix mb-sm-30">
                        ...
                        <div class="entry-content p-20 pr-10  bg-white">
                            <div class="entry-meta media mt-0 no-bg no-border">
                                ...
                                <div class="media-body pl-15">
                                    <div class="event-content pull-left flip">
                                        <h4 class="entry-title m-0 mt-5"><a class="text-theme-color-orange" href="#">This is a standard post with thumbnail</a></h4>
                                    </div>
                                </div>
                            </div>
                            <p class="mt-10">Lorem ipsum dolor sit amet, consectetur adipisi cing elit. Molestias eius illum libero dolor nobis deleniti, sint assumenda. Pariatur iste veritatis excepturi, ipsa optio nobis.
