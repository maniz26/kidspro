<section id="blog" data-bg-img="http://placehold.it/1600x677">
            ...
            <div class="row">
                    ...
                    <article class="post clearfix mb-sm-30">
                        ...
                        <div class="entry-content p-20 pr-10  bg-white">
                            <div class="entry-meta media mt-0 no-bg no-border">
                                <div class="entry-date media-left text-center flip bg-theme-color-orange pt-5 pr-15 pb-5 pl-15">
                                    <ul>
                                ...
                                <div class="media-body pl-15">
                                    <div class="event-content pull-left flip">
                                        <h4 class="entry-title m-0 mt-5"><a class="text-theme-color-blue" href="/kidspro#">This is a standard post with thumbnail</a></h4>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-theme-color-orange p-5 text-center pt-10 pb-10">
                    ...
                    <article class="post clearfix mb-sm-30">
                        ...
                        <div class="entry-content p-20 pr-10  bg-white">
                            <div class="entry-meta media mt-0 no-bg no-border">
                                ...
                                <div class="media-body pl-15">
                                    <div class="event-content pull-left flip">
                                        <h4 class="entry-title m-0 mt-5"><a class="text-theme-color-red" href="/kidspro#">This is a standard post with thumbnail</a></h4>
                                    </div>
                                </div>
                            </div>
                            <p class="mt-10">Lorem ipsum dolor sit amet, consectetur adipisi cing elit. Molestias eius illum libero dolor nobis deleniti, sint assumenda. Pariatur iste veritatis excepturi, ipsa optio nobis.
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <article class="post clearfix mb-sm-30">
                        ...
                        <div class="entry-content p-20 pr-10  bg-white">
                            <div class="entry-meta media mt-0 no-bg no-border">
                                <div class="entry-date media-left text-center flip bg-theme-color-lemon pt-5 pr-15 pb-5 pl-15">
                                    <ul>
                                        <li class="font-16 text-white font-weight-600 border-bottom">28</li>
                                        <li class="font-12 text-white text-uppercase">Feb</li>
                                    </ul>
                                ...
                                <div class="media-body pl-15">
                                    <div class="event-content pull-left flip">
                                        <h4 class="entry-title m-0 mt-5"><a class="text-theme-color-orange" href="/kidspro#">This is a standard post with thumbnail</a></h4>
                                    </div>
                                </div>
                            </div>
                            <p class="mt-10">Lorem ipsum dolor sit amet, consectetur adipisi cing elit. Molestias eius illum libero dolor nobis deleniti, sint assumenda. Pariatur iste veritatis excepturi, ipsa optio nobis.
                        </div>
                        <div class="bg-theme-color-lemon p-5 text-center pt-10 pb-10">
                            <span class="mb-10 text-white mr-10 font-13"><i class="fa fa-share-alt mr-5 text-white"></i>24 Share</span>
                            <span class="mb-10 text-white mr-10 font-13"><i class="fa fa-commenting-o mr-5 text-white"></i> 214 Comments</span>
                            <span class="mb-10 text-white mr-10 font-13"><i class="fa fa-heart-o mr-5 text-white"></i> 895 Likes</span>
                        </div>
    ...
    <div>
        <img alt="" src="http://placehold.it/1440x408" class="img-responsive img-fullwidth">
    </div>
</section>