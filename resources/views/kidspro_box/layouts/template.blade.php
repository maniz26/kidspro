...
<body class="boxed-layout pt-40 pb-40 pt-sm-0" data-bg-img="images/pattern/p33.png">
<div id="wrapper" class="clearfix">
    ...
    <!-- Header -->
    @if($header)
        @include('kidspro_box.layouts.headers.'.$header.'')
    @endif
    ...
    <!-- Footer -->
    @if($footer)
    @include('kidspro_box.layouts.footers.'.$footer.'')
    @endif
    <!-- End Footer -->
</div>
<!-- end wrapper -->
