@extends('kidspro_box.layouts.template')
...
@section('content')
    ...
    <section>
        ...
        <!-- Section: Features -->
    @if($feature)
        @include('kidspro_box.layouts.features.'.$feature.'')
    @endif
    ...
    <!-- Divider: Funfact -->
        ...
        <!-- Section: Courses -->
    @if($course)
        @include('kidspro_box.layouts.courses.'.$course.'')
    @endif
    ...
    <!-- Section: Our Gallery -->
                                ...
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="gallery-icon">
                                            <a href="http://placehold.it/350x265"  data-lightbox-gallery="gallery"><i class="pe-7s-science"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <!-- Section: Our Team -->
    @if($teacher)
        @include('kidspro_box.layouts.teachers.'.$teacher.'')
    @endif
    ...
    @if($testimonial)
        @include('kidspro_box.layouts.testimonials.'.$testimonial.'')
    @endif

    <!-- Section: blog -->
    @if($news)
        @include('kidspro_box.layouts.news.'.$news.'')
    @endif
