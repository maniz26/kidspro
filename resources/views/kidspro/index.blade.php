@extends('kidspro.layouts.template')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="rev_slider_wrapper">
            <div class="rev_slider rev_slider_default" data-version="5.0">
                <ul>
                    <!-- SLIDE 1 -->
                    <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x800" data-rotate="0"  data-fstransition="fade" data-saveperformance="off" data-title="Web Show" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="http://placehold.it/1920x800"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption sft"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-colored btn-theme-color-blue btn-lg btn-flat font-weight-600 pl-30 pr-30" href="/kidspro#">Contact Us</a>
                        </div>
                    </li>

                    <!-- SLIDE 2 -->
                    <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x1280" data-rotate="0"  data-fstransition="fade" data-saveperformance="off" data-title="Web Show" data-description="">
                        <!-- MAIN IMAGE -->
                    ...
                    <!-- SLIDE 3 -->
                    <li data-index="rs-3" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x800" data-rotate="0"  data-fstransition="fade" data-saveperformance="off" data-title="Web Show" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="http://placehold.it/1920x800"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                        <!-- LAYERS -->
...
<section class="divider"  data-bg-img="http://placehold.it/1600x422"  data-margin-top="-34px">
    <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="sm-height-auto">
                        <div class="text-center pb-sm-20">
                            <div class="icon-box text-center">
                                <a class="icon bg-theme-color-orange icon-circled icon-xl mb-10" href="/kidspro#"> <i class="fa fa-user text-white"></i> </a>
                                <h4 class="">Expert Teachers</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="sm-height-auto">
                        <div class="text-center pb-sm-20">
                            <div class="icon-box text-center">
                                <a class="icon bg-theme-color-sky icon-circled icon-xl mb-10" href="/kidspro#"> <i class="fa fa-graduation-cap text-white"></i> </a>
                                <h4 class="">Fully Equiped</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="sm-height-auto">
                        <div class="text-center pb-sm-20">
                            <div class="icon-box text-center">
                                <a class="icon bg-theme-color-red icon-circled icon-xl mb-10" href="/kidspro#"> <i class="fa fa-smile-o text-white"></i> </a>
                                <h4 class="">Funny and Happy</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="sm-height-auto">
                        <div class="text-center pb-sm-20">
                            <div class="icon-box text-center">
                                <a class="icon bg-theme-color-blue icon-circled icon-xl mb-10" href="/kidspro#"> <i class="fa fa-heart text-white"></i> </a>
        ...
        <div class="section-content">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <a href="/kidspro#" class="btn btn-flat btn-colored btn-theme-color-blue mt-15 mr-15">Read More</a><a href="/kidspro#" class="btn btn-flat btn-colored btn-theme-color-yellow mt-15">Get a Quote</a>
                </div>
                <div class="col-md-6">
...
<!-- Section: Features -->
<section class="">
    @include('kidspro.layouts.features.'.$feature.'')
</section>
<!-- Divider: Funfact -->
...
<!-- Section: Courses -->
<section class="" data-bg-img="http://placehold.it/1600x677">>
    @include('kidspro.layouts.courses.'.$course.'')
</section>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <div class="gallery-block">
                        <div class="gallery-thumb">
                            <img alt="project" src="http://placehold.it/350x265" class="img-fullwidth">
                        </div>
                        <div class="overlay-shade red"></div>
                        <div class="icons-holder">
                            <div class="icons-holder-inner">
                                <div class="gallery-icon">
                                    <a href="/kidsprohttp://placehold.it/350x265"  data-lightbox-gallery="gallery"><i class="pe-7s-science"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Section: Our Team -->
<section>
    @include('kidspro.layouts.teachers.'.$teacher.'')
</section>
        ...
        <div class="section-content">
            <div class="row">
                ...
                <div class="col-md-7 pb-sm-20">
                    <h2 class="title line-bottom mb-20 mt-0 line-height-1">Why <span class="text-theme-color-red">Choose Us</span> ?</h2>
                    ...
                    <div class="col-sm-6 col-md-3 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="icon-box text-center pl-0 pr-0 mb-0">
                            <a href="/kidspro#" class="icon bg-theme-color-red icon-circled icon-border-effect effect-circle icon-md">
                                <i class="fa fa-bell text-white"></i>
                            </a>
                            <h5 class="icon-box-title mt-15 mb-10 text-theme-color-red letter-space-4 text-uppercase">Responsive</h5>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="icon-box text-center pl-0 pr-0 mb-0">
                            <a href="/kidspro#" class="icon bg-theme-color-sky icon-circled icon-border-effect effect-circle icon-md">
                                <i class="fa fa-pencil text-white"></i>
                            </a>
                            <h5 class="icon-box-title mt-15 mb-10 text-theme-color-sky letter-space-4 text-uppercase">validation</h5>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="icon-box text-center pl-0 pr-0 mb-0">
                            <a href="/kidspro#" class="icon bg-theme-color-blue icon-circled icon-border-effect effect-circle icon-md">
                                <i class="fa fa-certificate text-white"></i>
                            </a>
                            <h5 class="icon-box-title mt-15 mb-0 text-theme-color-blue letter-space-4 text-uppercase">CERTIFICATION</h5>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="divider" data-bg-img="http://placehold.it/1920x504">
    @include('kidspro.layouts.testimonials.'.$testimonial.'')
</section>
<!-- Section: news  -->
<section id="blog" data-bg-img="http://placehold.it/1600x677">
    @include('kidspro.layouts.news.'.$news.'')
</section>
<!-- Divider: Clients -->
