...
<div class="container-fluid">
            ...
            <div class="page-header">
                <div class="page-title">
                    <ol class="breadcrumb ">
                        ...
                        <li class="active">{!! __('backendcp::menu.breadcrum.create') !!}</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section id="main-content">
        <div class="row">
            <form name="adminForm" class="form-horizontal" action="{{route('admin.menu.save')}}" method="post" enctype="multipart/form-data">
            {{ csrf_field()}}
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card">
                            ...
                            <div class="form-group {{ $errors->first('title', 'has-error') }}">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="title" class="form-control" placeholder="{{ __('backendcp::menu.fields.title_placeholder') }}" value="{{ old('title')}}">
                                </div>
                            </div>  
                                ...
                                <div class="col-sm-8">
                                   <select class="form-control border-none input-flat bg-ash" name="position">
                                     <option value="0">{{ __('backendcp::general.fields.root') }}</option> 
                                       ...
                                       <option value="{{$position['@attributes']['name']}}" @if( $position['@attributes']['name'] == old('category_id') ) selected @endif>{{$position['@attributes']['name']}}</option>                                    
                                    @endforeach
