			...
			<div class="page-header">
				<div class="page-title">
                    <ol class="breadcrumb ">
                        ...
                        <li class="active">{!! __('backendcp::module.title') !!}</li>        
			...
			<div class="col-lg-12">
				<div class="card alert">
					...
					<div class="row card-header">
						...
						@endif
						  <h4>@lang('backendcp::module.title')	 </h4>

						  <div class="card-header-right-icon">
                            <ul>
                                <li>
                                    <a href="{{ route('admin.module.batch.uninstall') }}"  class="btn btn-danger btn-addon m-b-10 btn-do-action" data-action="delete">
                                        <i class="fa fa-trash"></i> @lang('backendcp::general.fields.delete')
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.module.batch.unpublish') }}" class="btn btn-warning btn-addon m-b-10 btn-do-action" data-action="unpublish">
                                        <i class="fa fa-close"></i> @lang('backendcp::general.fields.unpublish')
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.module.batch.publish') }}" class="btn btn-success btn-addon m-b-10 btn-do-action" data-action="publish">
                                ...
                                <li>
                                    <a href="{{ route('admin.menu.new') }}" class="btn btn-primary  btn-addon m-b-10">
                                        <i class="glyphicon glyphicon-plus"></i> @lang('backendcp::module.fields.new')
                                    </a>
                                </li>
                            </ul>
                        </div>
							...
							<table id="bootstrap-data-table" class="table table-striped table-bordered">
								<thead>
									<tr>
										...
										<th>{!! __('backendcp::module.list.name') !!}</th>
										<th>{!! __('backendcp::module.list.position') !!}</th>
										<th>{!! __('backendcp::module.list.status') !!}</th>
										<th>{!! __('backendcp::addon.list.created') !!}</th>
										<th>{!! __('backendcp::module.list.actions') !!}</th>
									</tr>
								</thead>
								<tbody>
								</tbody>
