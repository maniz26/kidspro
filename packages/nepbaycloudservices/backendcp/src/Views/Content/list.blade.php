            ...
            <div class="page-header">
                <div class="page-title">
                    <ol class="breadcrumb ">
                        ...
                        <li class="active">{!! __('backendcp::content.breadcrum.articles') !!}</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card alert">
                    ...
                    <div class=" row card-header">
                        ...
                        @endif
                        <h4>
                        @lang('backendcp::content.breadcrum.articles')
                        </h4>
                        <div class="card-header-right-icon">
                            <ul>
                                <li>
                                    <a href="{{ route('admin.content.batch.delete') }}"  class="btn btn-danger btn-addon m-b-10 btn-do-action" data-action="delete">
                                        <i class="fa fa-trash"></i> @lang('backendcp::general.fields.delete')
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.content.batch.unpublish') }}" class="btn btn-warning btn-addon m-b-10 btn-do-action" data-action="unpublish">
                                        <i class="fa fa-close"></i> @lang('backendcp::general.fields.unpublish')
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.content.batch.publish') }}" class="btn btn-success btn-addon m-b-10 btn-do-action" data-action="publish">
                                ...
                                <li>
                                    <a href="{{ route('admin.content.new') }}" class="btn btn-primary  btn-addon m-b-10">
                                        <i class="glyphicon glyphicon-plus"></i> @lang('backendcp::content.fields.new')
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <table class="table table-striped table-bordered" id="contentTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('backendcp::general.list.title')</th>
                                        <th>@lang('backendcp::content.fields.introtext')</th>
                                        <th>@lang('backendcp::content.fields.fulltext')</th>
                                        <th>@lang('backendcp::general.list.image')</th>
                                        <th>@lang('backendcp::general.list.featured')</th>
                                        <th>@lang('backendcp::general.list.status')</th>
    ...
    $(function() {
        var table = $('#contentTable').DataTable({
            ...
            ajax: '{!! route('admin.content.data') !!}',
                ...
                { data: 'introtext', name: 'introtext' },
                { data: 'fulltext', name: 'fulltext' },
        ...
        $('.btn-do-action').click(function(e){                
            ...
            if( $('.checkbox:checked').length == 0){
                alert("{{ __('backendcp::content.action.alert')}}");
                return false;
            }

            if( $(this).data('action') =='delete'){
                var conf =confirm("{{ __('backendcp::content.delete.alert')}}");
                if(!conf)
                    return false;
            }
