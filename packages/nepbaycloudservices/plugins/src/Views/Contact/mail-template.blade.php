...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td bgcolor="#f7f7f7" align="center" style="padding:50px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" style="max-width:650px; padding:20px; border:1px solid #b2b2b2;">
        ...
        <tr>
          <td align="center" style="font-size:12px; font-weight:normal; color:#868787; margin:0; padding:0; padding-bottom:30px; padding-top:10px;">You have a {{$details['subject']}} message.</td>
        </tr>
        <tr>
  ...
  <tr>
    <td width="30"><img src="{{asset('newsletter/img/user.png')}}" /></td>
  ...
  <tr>
    ...
    <td style="font-size:12px; color:#545454; font-weight:normal; padding-top:10px"><a href="mailto:{{$details['email']}}" style="color:#545454; text-decoration: none;">{{$details['email']}}</a></td>
  </tr>
  <tr>
    ...
    <td style="font-size:12px; color:#545454; font-weight:bold; padding-top:10px" width="30" align="center">:</td>
    <td style="font-size:12px; color:#545454; font-weight:normal; padding-top:10px"><a href="tel:{{$details['phone']}}" style="color:#545454; text-decoration: none;">{{$details['phone']}}</a></td>
  </tr>
  <tr>
    <td style="padding-top:10px"  valign="top" ><img src="{{asset('newsletter/message.png')}}" width="16" height="16"/></td>
    <td style="font-size:12px; color:#545454; font-weight:bold; padding-top:10px" valign="top">Message</td>
    <td style="font-size:12px; color:#545454; font-weight:bold; padding-top:10px" width="30" align="center"  valign="top" >:</td>
    <td style="font-size:12px; color:#545454; font-weight:normal; padding-top:10px">{!! nl2br($details['message']) !!}</td>
  </tr>
</table>
