<div class="InnerPage">
  <div class="container">
    <h1> <span></span>Submit Your Experience</h1>
    ...
    @endif
      <form method="post" name="domflight" id="domflight" action="{{route('frontend.experience.send')}}">
        {{csrf_field()}}
        <input type="hidden" name="subject" value="Client Experience">
        <div class="SearchModifyPopup">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <textarea name="message" placeholder="Describe your experience" class="form-control" rows="5">{{old('Message')}}</textarea>
              </div>
               <div class="form-group">
                <div class="g-recaptcha" data-sitekey="{{env('GOOGLE_RECAPTCHA_KEY')}}"></div>
              </div>
              <div class="form-group">
                <button type="submit" class="btn btn-primary ncs-domflight-search btn-default BtnDefault">Send</button>
              </div>
            </div>
            </div>
            <div class="col-md-6">
