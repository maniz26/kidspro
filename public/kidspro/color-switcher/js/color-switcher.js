...
jQuery(document).ready(function($) {
    ...
    $('#switcher-layout-mode a').on('click', function(e) {
        $(this).parent().find('a').removeClass('btn btn-theme-color-sky btn-dark').addClass('btn btn-border btn-theme-color-sky');
        var layout_mode = $(this).removeClass('btn btn-border btn-theme-color-sky').addClass('btn btn-theme-color-sky btn-dark').data('layout-mode');
        if( layout_mode == "wide" ) {
    ...
    $('#switcher-bgcolor a').on('click', function(e) {
        $(this).parent().find('a').removeClass('btn btn-theme-color-sky btn-dark').addClass('btn btn-border btn-theme-color-sky');
        var bgcolor = $(this).removeClass('btn btn-border btn-theme-color-sky').addClass('btn btn-theme-color-sky btn-dark').data('bgcolor-type');
        if( bgcolor == "dark" ) {
            $('body').addClass('dark');
    ...
    $('#switcher-rtl a').on('click', function(e) {
        $(this).parent().find('a').removeClass('btn btn-theme-color-sky btn-dark').addClass('btn btn-border btn-theme-color-sky');
        var direction_type = $(this).removeClass('btn btn-border btn-theme-color-sky').addClass('btn btn-theme-color-sky btn-dark').data('direction-type');
